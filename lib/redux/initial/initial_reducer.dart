...
initialReducer(InitialState prevState, SetInitialStateAction action) {
  ...
  return prevState.copyWith(isError: payload.isError, isLoading: payload.isLoading, isSuccess: payload.isSuccess, articles: payload.articles, films: payload.films, shows: payload.shows);
}